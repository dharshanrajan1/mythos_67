...
export function MobileTaskItem({ task, onDelete, onStatusChange }: MobileTaskItemProps) {
    ...
    return (
        <div ref={setNodeRef} style={style} className="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/5 touch-none select-none">
            <button
            ...
            <div {...attributes} {...listeners} className="text-zinc-600 cursor-grab active:cursor-grabbing p-2 hover:bg-white/5 rounded-md touch-none">
